...
export const Profile: React.FC<ProfileProps> = ({ settings = false, user }) => {
  ...
  if (!user) {
    return <div>Loading user data...</div>; // Handle the case where user is undefined or null
  }
